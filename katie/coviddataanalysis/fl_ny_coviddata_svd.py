...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul  6 21:36:05 2020
...
coviddata = pd.read_csv('/Users/katie/Downloads/fl_ny_coviddata.csv')
...
svd_df = pd.DataFrame(u[:,0:2], index=coviddata_meta["State"].tolist(), columns=labels)
